...
}[] = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-7 h-7" fill="none">
        <text x="0" y="18" fontSize="13" fontWeight="bold" fill="#003087">Pay</text>
        <text x="0" y="18" fontSize="13" fontWeight="bold" fill="#009cde" dx="22">Pal</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" className="w-7 h-7">
        <rect width="40" height="40" rx="10" fill="#6c00ea" />
        <text x="50%" y="55%" textAnchor="middle" dominantBaseline="middle" fill="white" fontSize="13" fontWeight="bold">N</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" className="w-7 h-7">
        <rect width="40" height="40" rx="10" fill="#f5a800" />
        <text x="50%" y="55%" textAnchor="middle" dominantBaseline="middle" fill="white" fontSize="11" fontWeight="bold">BC</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" className="w-7 h-7">
        <rect width="40" height="40" rx="10" fill="#e0001b" />
        <text x="50%" y="55%" textAnchor="middle" dominantBaseline="middle" fill="white" fontSize="11" fontWeight="bold">DP</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" className="w-7 h-7">
        ...
        <text x="50%" y="55%" textAnchor="middle" dominantBaseline="middle" fill="white" fontSize="12" fontWeight="bold">PSE</text>
      </svg>
    ),
  },
];
